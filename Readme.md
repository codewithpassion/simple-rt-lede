...
tcpdump -nn -i br-lan -XX src !10.1.1.248 and dst !8.8.8.8 and src !192.168.254.1 and !ip6 and port !22

    tcpdump -nn -i br-lan -XX  dst !8.8.8.8 and src !192.168.254.1 and !ip6 and port !22


    tcpdump -nn -i br-lan -XX  dst !8.8.8.8 and src !192.168.254.1 and !ip6 and port !22 and port!53 and port !7400 and port !8088
